#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/platform/13500000.dwmmc0/by-name/recovery:55574528:0dec8d2b8ee2c83487f5e2f47ce7bfeeb7e80490; then
  applypatch EMMC:/dev/block/platform/13500000.dwmmc0/by-name/boot:37748736:d4a71b4a6f27518bbc37446f766447269e40c76f EMMC:/dev/block/platform/13500000.dwmmc0/by-name/recovery 0dec8d2b8ee2c83487f5e2f47ce7bfeeb7e80490 55574528 d4a71b4a6f27518bbc37446f766447269e40c76f:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
